...
function ProjectPageHeroSection({
  ...
  return (
    <div className="min-h-auto">
      ...
      <section
        className="bg-dark-section-primary z-0 relative items-center justify-center"
        style={{
      ...
      >
        <div className="text-center -mt-16 md:-mt-20">
          <div className="mx-8 lg:mx-44 pt-24 md:pt-32 pb-8 md:pb-16 lg:pb-44">
            <h1 className="text-dark-text-primary lg:text-6xl text-4xl md:text-5xl font-bold lg:text-left">
              {header}
            </h1>
            <hr className="border-action-blue border-t-4 md:border-t-8 mt-4 w-1/2 mx-auto lg:mx-0" />
            <p className="text-dark-text-secondary md:text-3xl text-xl lg:text-left mt-4">
              {subheader}
            </p>
          </div>
        </div>
