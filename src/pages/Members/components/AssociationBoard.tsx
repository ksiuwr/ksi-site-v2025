export const AssociationBoard = () => {
 ...
 <section className="bg-dark-section-primary z-10 pt-24 pb-36 relative items-center justify-center ">
  ...
  {/* Przewodniczący */}
    <div className="flex flex-col lg:flex-row items-center gap-8 mt-[3vw]">
