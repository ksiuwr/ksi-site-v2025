...
export const RegularMembers = () => {
	return (
      ...
      <h2 className="text-sans text-2xl md:text-4xl font-bold ml-[13vw] mt-[4vw]">Członkowie</h2>
      <hr className="border-action-blue border-t-2 mt-2 ml-[12vw] mr-[13vw] md:mr-[45vw]"/>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-8 pt-10 sm:pt-20">
